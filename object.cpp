...
{
        return (((sprites[this->sprite].bbox.x2 - sprites[this->sprite].bbox.x1) + 1) << CSF);
}
int Object::BBoxHeight()
{
        return (((sprites[this->sprite].bbox.y2 - sprites[this->sprite].bbox.y1) + 1) << CSF);
}
...
int Object::Left()
{
        return (this->x + (sprites[this->sprite].bbox.x1 << CSF));
}
int Object::Right()
{
        return (this->x + (sprites[this->sprite].bbox.x2 << CSF));
}
int Object::Top()
{
        return (this->y + (sprites[this->sprite].bbox.y1 << CSF));
}
int Object::Bottom()
{
        return (this->y + (sprites[this->sprite].bbox.y2 << CSF));
}

int Object::SolidLeft()
{
        return (this->x + (sprites[this->sprite].solidbox.x1 << CSF));
}
int Object::SolidRight()
{
        return (this->x + (sprites[this->sprite].solidbox.x2 << CSF));
}
int Object::SolidTop()
{
        return (this->y + (sprites[this->sprite].solidbox.y1 << CSF));
}
int Object::SolidBottom()
{
        return (this->y + (sprites[this->sprite].solidbox.y2 << CSF));
}

int Object::ActionPointX()
{
        return (this->x + (sprites[this->sprite].frame[this->frame].dir[this->dir].actionpoint.x << CSF));
}
int Object::ActionPointY()
{
        return (this->y + (sprites[this->sprite].frame[this->frame].dir[this->dir].actionpoint.y << CSF));
}
int Object::ActionPoint2X()
{
        return (this->x + (sprites[this->sprite].frame[this->frame].dir[this->dir].actionpoint2.x << CSF));
}
int Object::ActionPoint2Y()
{
        return (this->y + (sprites[this->sprite].frame[this->frame].dir[this->dir].actionpoint2.y << CSF));
}

int Object::DrawPointX()
{
        return (sprites[this->sprite].frame[this->frame].dir[this->dir].drawpoint.x << CSF);
}
int Object::DrawPointY()
{
        return (sprites[this->sprite].frame[this->frame].dir[this->dir].drawpoint.y << CSF);
}
